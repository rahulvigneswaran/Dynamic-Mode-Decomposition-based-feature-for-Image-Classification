...
This repo consists of all the codes and dataset of the research paper, **"[Dynamic Mode Decomposition based feature for Image Classification](https://ieeexplore.ieee.org/document/8494096)"**.
